...
base_dir = "/home/nicolai/sra/code/clevr-dataset-gen/output/train/scenes"
...
for file in json_files:
    with open(os.path.join(base_dir, file), "r") as f:
        data = json.load(f)
        extrinsics = np.array(data["extrinsics"])
...
o3d.visualization.draw_geometries([base_frame] + coordinate_frames)
